    ...
    <section id="certificates" className="relative py-20 sm:py-24">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            <motion.button
              className="fixed right-4 top-4 z-[9999] rounded-full bg-black/60 px-3 py-1 text-4xl leading-none text-white backdrop-blur-md transition duration-300 hover:text-red-400 sm:right-8 sm:top-6"
              onClick={() => setSelectedImage(null)}
            ...
            <motion.div
              ...
              className="flex max-h-[90vh] w-full items-center justify-center"
            >
              <img
                src={selectedImage}
